        ...
        {tela==="home"&&(
          <div>
            ...
            {minhas.map(p=>{
              ...
              return <Card key={p.id} style={{ cursor: completa?"default":"pointer" }} onClick={()=>{if(!completa){setPSel(p);setTela("bairro");}}}>
                ...
                <PBar value={feitas} max={total} color={completa?"#1D9E75":"#185FA5"} height={4}/>
              </Card>;
            })}
          </div>
        )}
