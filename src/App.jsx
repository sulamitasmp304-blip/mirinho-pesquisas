    ...
    if (perg.tipo === "nota" && r?.media !== undefined) {
      ...
      return `
        <div style="text-align:center;margin:20px 0;">
          <div style="font-size:16px;font-weight:700;margin-bottom:12px;">${titulo}</div>
      ...
      return `<div style="margin:20px 0;"><div style="font-size:16px;font-weight:700;text-align:center;margin-bottom:16px;">${titulo}</div>${bars}</div>`;
    }
  ...
  p.perguntas.forEach((perg, i) => {
    ...
    paginas.push(`
      <div class="page">
        ...
        ${buildGrafico(perg, rGeral, "Geral")}
        <div class="rodape">${RODAPE}</div>
      </div>
    `);
...
const PainelAdmin = ({ user, onLogout }) => {
  ...
  const NAV_ITEMS = [["dashboard","📊","Dashboard"],["pesquisas","📍","Pesquisas"],["equipe","👥","Equipe"],["financeiro","💰","Financeiro"],["pdf","📄","PDF"]];
  const Sidebar = () => (
