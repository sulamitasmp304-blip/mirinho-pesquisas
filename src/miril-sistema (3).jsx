...
const buildPdfHtml = (p, fmtD) => {
  ...
  // BLOCO GERAL — todas as perguntas
  ...
  // BLOCO POR BAIRRO — título + todas as perguntas de cada bairro
  p.bairros.forEach(b => {
    const resBairro = porBairro[b.nome];
    if (!resBairro) return;

    // Página de título do bairro
    paginas.push(`
      <div class="page capa">
        <div style="font-size:18pt;font-weight:700;color:#555;margin-bottom:16px;">Resultados por Setor</div>
        <div style="font-size:48pt;font-weight:900;color:#000;margin:20px 0;">${b.nome}</div>
        <div style="font-size:12pt;color:#888;">${b.feitas||0} entrevistas realizadas</div>
        <div class="rodape">${RODAPE}</div>
      </div>
    `);
